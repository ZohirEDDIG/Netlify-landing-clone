            ...
            <AnimatePresence>
                {
                    isOpen && (
                        <motion.div 
                            className='w-[600px] border-2 border-gray-600 rounded-lg flex absolute top-10'
                        ...
                        >
                            ...
                            {/* Key Features */}
                            <div className='bg-dark-green-primary rounded-r-md flex-1 flex flex-col gap-y-4'>

                                <h2 className='text-gray-500 font-mono font-bold px-8 pt-8'>USE CASES</h2>

                                <div className='px-8 pb-8 flex flex-col gap-y-4'>
                                ...
                                <div className='p-8 border-t border-gray-500 flex flex-col gap-y-4'>

            ...
            <AnimatePresence>
                {
                    isOpen && (
                        ...
                        >
                            ...
                            {/* Key Features */}
                            <div className='bg-dark-green-primary p-8 rounded-r-md flex-1 flex flex-col gap-y-4'>
                                ...
                                <div className='grid grid-cols-2 gap-x-8 gap-y-4'>
                                    ...
                                    <Link 
                                        href='/with/nextjs' 
                                        className='font-normal underline flex items-center gap-x-2 select-none
                                        transition-colors duration-300 ease-in-out hover:text-light-green-secondary'
                                    >
